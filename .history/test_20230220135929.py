...
def validate_url(url:str = '') -> bool:
    """简单校验url合法性"""
    if not re.match(r'^(http(s)?|ftp|file)://.+$', url):
        return False
    return True

print(validate_url('www.baidu.com'))
print(validate_url())
print(validate_url('http://www.baidu.com'))
print(validate_url('http://www.baidu.com/02/bs_1.html'))
# class url_parser:
