...
if __name__ == '__main__':
    """每次加载时设置baseurl"""
    main = diyibanzhu()
    novel = main.get_novel('http://www.2diyibanzhu.cc/32/32880/754225_4.html')
    novel = main.get_novel('http://www.2diyibanzhu.cc/32/32880/754225.html')
    novel = main.get_novel('/32/32880/754225.html')
    print(novel)
