...
class text_processor :
    ...
    def __init__(self, solve_text : str = '', 
                 img_process:bool = False,
                 format_process:bool = False,
                 ad_process:bool = False) -> None:
    ...
    def img_process(self, solve_text:str = '') -> str:
        """正则匹配图片链接并替换链接"""
        text = solve_text
    ...
    def format_processor(self, solve_text:str = '') -> str:
        text = solve_text
        if str_is_empty(text):
            text = self.__solve_text
